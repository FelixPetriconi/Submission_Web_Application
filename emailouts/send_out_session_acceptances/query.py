...
def query():
    ...
    all(p.session_type in (SessionType.session, SessionType.miniworkshop, SessionType.workshop, SessionType.quickie) for p in proposals)
...
"""
As this session is a quickie, the conference is not able to provide a
'presenter package' for putting on this session, the presenter will have to
register for the conference via some other route.
